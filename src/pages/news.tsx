...
const NewsCard = ({ a }: { a: Article }) => {
  ...
  return (
    <LayoutCard padded>
      <p style={{ fontSize: 12, color: "var(--color-muted-fg)", marginBottom: 4 }}>{a.date}</p>
      <h2 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8 }}>{a.title}</h2>
      <p style={{ fontSize: 14, color: "var(--color-muted-fg)", lineHeight: 1.5 }}>{a.excerpt}</p>
      {open && (
        <p
          style={{
            fontSize: 14,
...
const NewsPage = () => (
  <div className="page-container">
    <h1 style={{ fontSize: 24, fontWeight: 700 }}>Новости</h1>
